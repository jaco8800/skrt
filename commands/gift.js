...
module.exports.run = async (bot, message, args) => {
  ...
  if (Math.ceil(personGiftingDocument.points) < howMuch) return message.channel.send(`Not enough points. Type ${botconfig.prefix}pointshelp to learn how to earn points.`);
