...
module.exports.run = async (bot, message, args) => {
    ...
    for (let i = 0; i < 2; i++) {
        ...
        const doublerng = packSimulator.randomInt(1, 20);
        ...
        } else if (rng > 76 && rng < 79) { //90+
            const rng90 = ran100();

            if (rng90 > 22 && rng90 < 25) {
                arrpush(players.good90);
            } else {
                arrpush(players.bad90);
            }
        } else if (rng >= 110 && rng <= 110) { //87-89
